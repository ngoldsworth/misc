...
\begin{itemize}
    ...
    \item 2 cups graham cracker crumbs. (\texit{1 package of crackers $\approx$ 1 cup crushed. Use food processor to chop and grind to fine powder})
...
\begin{enumerate}
    ...
    \item Place parchment paper in pan if desired. Pour peanut butter mixture into 9" \cross 13" pan. (\textit{Or smaller. I like it with a bit more thickness}). May require pressing and spreading into pan by hand. 
